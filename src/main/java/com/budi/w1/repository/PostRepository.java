...
import com.budi.w1.mapper.PostMapper;
...
public class PostRepository {
    ...
    @Autowired
    private JdbcTemplate jbsTemplate;
    ...
    public Post findOne(Long id){
        ...
        return this.jbsTemplate.queryForObject(sql, rowMapper,id);
    }

    public List<Post> findPost(){
        String sql = "SELECT * FROM post ORDER BY updt_date DESC";
        RowMapper<Post> rowMapper = new PostMapper();
        return this.jbsTemplate.query(sql, rowMapper);
    }
    ...
    public List<Post> findPostLikeTitle(String query){
        ...
        RowMapper<Post> rowMapper = new PostMapper();
        return this.jbsTemplate.query(sql, rowMapper, '%'+query+'%');
    }
    ...
    public int savePost(Post post){
        ...
        return jbsTemplate.update(sql, post.getUser(),post.getTitle(), post.getContent(), post.getRegDate(), post.getUpdtDate());
    }
}
